...
class RateMyProfApi:
    ...
    def get_num_of_professors(
        ...
        # url = "http://www.ratemyprofessors.com/filter/professor/?&page=1&filter=teacherlastname_sort_s+asc&query=*%3A*&queryoption=TEACHER&queryBy=schoolId&sid="+ str(id)
            
        url = "https://www.ratemyprofessors.com/school/{id}"
...
if __name__ == '__main__':
    ...
    umn = RateMyProfApi(1257)
    umn.search_professor("Jack Kolb")
    umn.print_professor_detail("overall_rating")
